...
RCT_EXPORT_METHOD(getData:(RCTResponseSenderBlock) cb) {
    ...
    double timestamp = [RNUtils sensorTimestampToEpochMilliseconds:self->_motionManager.gyroData.timestamp];
...
RCT_EXPORT_METHOD(startUpdates) {
    ...
    [self->_motionManager startGyroUpdatesToQueue:[NSOperationQueue mainQueue]
                                      withHandler:^(CMGyroData *gyroData, NSError *error)
     {
         ...
         double timestamp = [RNUtils sensorTimestampToEpochMilliseconds:gyroData.timestamp];
