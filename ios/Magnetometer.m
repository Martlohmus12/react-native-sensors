...
RCT_EXPORT_METHOD(getData:(RCTResponseSenderBlock) cb) {
    ...
    double timestamp = [RNUtils sensorTimestampToEpochMilliseconds:self->_motionManager.magnetometerData.timestamp];
...
RCT_EXPORT_METHOD(startUpdates) {
    ...
    [self->_motionManager startMagnetometerUpdatesToQueue:[NSOperationQueue mainQueue]
                                               withHandler:^(CMMagnetometerData *magnetometerData, NSError *error)
     {
         ...
         double timestamp = [RNUtils sensorTimestampToEpochMilliseconds:magnetometerData.timestamp];
