...
RCT_EXPORT_METHOD(getData:(RCTResponseSenderBlock) cb) {
    ...
    double timestamp = [RNUtils sensorTimestampToEpochMilliseconds:self->_motionManager.accelerometerData.timestamp];
...
RCT_EXPORT_METHOD(startUpdates) {
    ...
    [self->_motionManager startAccelerometerUpdatesToQueue:[NSOperationQueue mainQueue]
                                               withHandler:^(CMAccelerometerData *accelerometerData, NSError *error)
     {
         ...
         double timestamp = [RNUtils sensorTimestampToEpochMilliseconds:accelerometerData.timestamp];
